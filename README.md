...
> **This branch (`main-26.2`) targets Minecraft 26.2.** Playing a different version? Switch
> to the [`26.3`](../../tree/26.3) or [`1.20.4`](../../tree/1.20.4) branch instead — the
> install steps below are branch-specific. (Versions before 26.2, such as 1.20.4, need an
> Iris shader pack for depth of field.)
